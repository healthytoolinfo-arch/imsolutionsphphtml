   ...
   <body>
    ...
    <section class="section" id="projects">
      <div class="container">
        ...
        <div class="projects-second-image">
          <img
      ...
      <div class="container">
          ...
          <div class="footer-section">
            ...
            <div class="social-links">
              <a href="#" class="social-link" aria-label="LinkedIn">
                ...
                >
                  <path
                    d="M16 8C18.2091 8 20.2091 8.79107 21.6569 10.2388C23.1046 11.6866 23.8957 13.6866 23.8957 16V21H19.8957V16C19.8957 15.2044 19.5796 14.4413 19.0169 13.8787C18.4543 13.316 17.6913 13 16.8957 13C16.1 13 15.337 13.316 14.7744 13.8787C14.2117 14.4413 13.8957 15.2044 13.8957 16V21H9.89569V16C9.89569 13.6866 10.6868 11.6866 12.1345 10.2388C13.5822 8.79107 15.5822 8 17.7913 8H16Z"
                    stroke="currentColor"
                    stroke-width="2"
                  />
                  <rect
              ...
              <a href="#" class="social-link" aria-label="Twitter">
                ...
                >
                  <path
                    d="M22 4S20.9 4.5 20 5C19.1 4 17.6 3.4 16 3.4C12.8 3.4 10.1 6.1 10.1 9.3C10.1 9.7 10.1 10.1 10.2 10.5C5.6 10.2 1.5 7.9 -0.5 4.5C-1 5.4 -1.3 6.4 -1.3 7.5C-1.3 9.5 -0.3 11.3 1.3 12.3C0.5 12.3 -0.3 12 -1 11.6V11.7C-1 14.4 1.1 16.6 3.7 17.1C3.2 17.2 2.7 17.3 2.1 17.3C1.7 17.3 1.3 17.3 0.9 17.2C1.7 19.4 4 21 6.7 21C4.5 22.7 1.8 23.7 -1.1 23.7C-1.6 23.7 -2.1 23.7 -2.6 23.6C0.2 25.4 3.5 26.4 7.1 26.4C16 26.4 21 17.3 21 9.3C21 9.1 21 8.9 21 8.7C22 8 22.8 7.1 23.4 6.1L22 4Z"
                    stroke="currentColor"
                    stroke-width="2"
                  />
                </svg>
        ...
        <div class="footer-bottom">
          <div class="footer-bottom-left">
            <p>© 2024 i'm solutions. All rights reserved.</p>
    ...
    <script>
      ...
      window.addEventListener("scroll", function () {
        ...
        // Remove active if we're at the top
...
<script type="text/javascript">
  ...
  document
    ...
    .addEventListener("submit", function (e) {
      ...
      // Rellenar campo oculto con la hora actual en español
      document.getElementById("time").value = new Date().toLocaleString("es-ES");

      emailjs
        .sendForm("service_9yatyia", "template_ta16eku", this)
        .then(
          function () {
          ...
          function (error) {
            alert("Oops... algo salió mal: " + error.text);
          }
        );
    });
</script>
